 ...
 *
 */
function abc_preprocess_html(&$variables) {
  // Admins get special CSS
 ...
 *
 */
function abc_preprocess_page(&$variables) {
  // Footer menu.
  $variables['footer_menu_links'] = menu_navigation_links('menu-footer-menu');
  if (!empty($variables['footer_menu_links'])) {
    $variables['footer_menu'] = theme('links', array(
      'links' => $variables['footer_menu_links'],
      'attributes' => array(
        'id' => 'footer-menu',
        'class' => array('footer-nav'),
      ),
      'heading' => array(
        'text' => t('Footer'),
        'level' => 'h2',
 ...
 */
//function abc_preprocess_block(&$variables) {
...
//function abc_preprocess_views_view(&$variables) {
//}
 ...
 *
 */
//function abc_preprocess_panels_pane(&$variables) {
//}
 ...
 *
 */
//function abc_preprocess_views_view_fields(&$variables) {
//}
 ...
 */
//function abc_form_element_label($variables) {
 ...
 */
//function abc_preprocess_button(&$variables) {
